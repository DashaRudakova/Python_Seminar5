...
with open('text_for_RLE_task4.txt', 'w', encoding='UTF-8') as file:
    file.write(input('Напишите текст необходимый для сжатия: '))
with open('text_for_RLE_task4.txt', 'r') as file:
...
with open('text_compression_RLE_task4.txt', 'w', encoding='UTF-8') as file:
